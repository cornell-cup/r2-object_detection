...
th = {'Rev2': 0, 'Rev3': 0, 'Rev4': 0, 'Rev5': 0, 'Rev6': 0}
...
v4 = []
for i in range(3):
    v1.append([ret['base_link'].pos[i], ret['link2_1'].pos[i]])
    v2.append([ret['link2_1'].pos[i], ret['link3_1'].pos[i]])
    v3.append([ret['link3_1'].pos[i], ret['link4_1'].pos[i]])
    v4.append([ret['link4_1'].pos[i], ret['link5_1'].pos[i]])

ax.plot(v1[0], v1[1], zs=v1[2], color='green')
ax.plot(v2[0], v2[1], zs=v2[2], color='green')
ax.plot(v3[0], v3[1], zs=v3[2], color='green')
ax.plot(v4[0], v4[1], zs=v4[2], color='green')
