...
if __name__ == '__main__':
    ...
    try:
        for i in range(5):
            ...
            # squeeze the points until they are within some distance from the
            # center depth
            # and update the z before doing camera projection to get correct
            # world coords
            clamp_x1, clamp_y1, clamp_x2, clamp_y2, z1, z2 = clamp_z(img_pt1, img_pt2, depth_frame)
            squeezed_pt1 = (img_pt1[0], img_pt1[1], z1)
            squeezed_pt2 = (img_pt2[0], img_pt2[1], z2)
            
            #convert grasp coords to cam and arm coords, output is a tuple
            cam_pt1 = proj_grasp_img_to_cam(squeezed_pt1, depth_frame)
            cam_pt2 = proj_grasp_img_to_cam(squeezed_pt2, depth_frame)
            
            gripper_pt1_cam = (cam_pt1[0], cam_pt1[1], z1)
            gripper_pt2_cam = (cam_pt2[0], cam_pt2[1], z2)
